(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module, exports) {
        ...
        var App = /** @class */ (function () {
            ...
            App.prototype.login = function () {
                ...
                authorization_service_configuration_1.AuthorizationServiceConfiguration.fetchFromIssuer(openIdConnectUrl)
                    .then(function (response) {
                        ...
                        _this.makeAuthorizationRequest();
                    })
            ...
            App.prototype.getToken = function (cb) {
                var _this = this;
                authorization_service_configuration_1.AuthorizationServiceConfiguration.fetchFromIssuer(openIdConnectUrl)
                    .then(function (response) {
                        logger_1.log('Fetched service configuration', response);
            ...
            App.prototype.makeTokenRequest = function (cb) {
                var _this = this;
                if (!this.configuration) {
            ...
            App.prototype.checkAuth = function (cb) {
                var _this = this;
                this.authorizationHandler.completeAuthorizationRequestIfPossible(function() { _this.getToken(cb) });
            };
            App.prototype.getUserInfo = function (token, cb) {
                var _this = this;
                var fullUrl = openIdConnectUrl + "/userinfo";
                var requestorToUse = new xhr_1.JQueryRequestor();
    ...
    }, { "../authorization_request": 2, "../authorization_request_handler": 3, "../authorization_service_configuration": 5, "../logger": 9, "../redirect_based_handler": 11, "../token_request": 13, "../token_request_handler": 14, "../xhr": 16 }], 2: [function (require, module, exports) {
        "use strict";
        /*
         * Copyright 2017 Google Inc.
         *
        ...
        var AuthorizationRequestHandler = /** @class */ (function () {
             ...
             */
            AuthorizationRequestHandler.prototype.completeAuthorizationRequestIfPossible = function (cb) {
                var _this = this;
